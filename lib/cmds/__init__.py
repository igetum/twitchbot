...
cmds = [
	...
	Cmd(["toplist"], economy.topList),
	Cmd(["addCoins"], economy.addCoins),
	Cmd(['rmvCoins'], economy.rmvCoins),

	#	games
	Cmd(["coinflip", "flip"], games.coinflip, cooldown=1),
	Cmd(["heist"], games.start_heist, cooldown=15),
